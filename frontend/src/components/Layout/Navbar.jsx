...
const Navbar = () => {
  ...
  return <header className="flex top-0 left-0 right-0 z-50 bg-white/95 backdrop:blue-sm border-b border-gray-100">
    <div className="container mx-auto px-4">
      <div className="flex items-center justify-between h-16">
        ...
        <span className="text-lg font-bold text-gray-950">Job India</span>
        </Link>
        ...
        <div className="flex items-center space-x-3">
          {user && (
            <button
            className="p-2 rounded-2xl hover:bg-gray-100 transition-colors duration-200 relative"
