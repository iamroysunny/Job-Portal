...
const ApplicantProfilePreview = ({ 
  ...
  return <div className="fixed inset-0 bg-[rgba(0,0,0,2)] bg-opacity-50 flex items-center justify-center p-4 gap-y-2">
    <div className="bg-white rounded-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
      ...
      <div className="p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <h5 className="font-medium text-gray-600 text-sm mb-2">
              Application Deatils
            </h5>
          ...
          {/* Status Dropdown*/}
          <div className="mt-4">
            <label className="black mb-1 text-sm text-gray-700 font-medium">
