          ...
          <div className="bg-white p-6 rounded-lg">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-lg lg:text-xl font-semibold leading-light text-gray-900">
                  Saved Job
                </h1>
              </div>

              <div className="flex items-center gap-3 lg:gap-4">
                <div className="flex items-center border border-gray-200 rounded-xl p-0 bg-white">
                  <button
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              {savedJobList.length === 0 ? (
                ...
                className={
                  viewMode === "grid"
                  ? "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4 lg:gap-0.5"
