...
import {Search, Filter, Grid, List, X, Key, Section } from "lucide-react";
...
const JobSeekerDashboard = () => {
  ...
  const fetchJobs = async (filterParams = {}) => {
    try {
      ...
      setError("Failed to fetch you . Please try again later");
      setJobs([]); 
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="min-h-screen mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 px-4 lg:py-8">
          {/* Search Header */}
          <SearchHeader
          filters={filters}
          handleFilterChange={handleFilterChange}
               ...
               <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-6 lg:mb-8 gap-4">
                ...
                {jobs.length === 0 ? (
                  <div className="text-center py-16 lg:py-20 bg-white/60 backdrop-blue-xl rounded-2xl border border-white/20">
                    ...
                    className="bg-blue-600 text-white px-3 rounded-xl font-semibold hover:bg-blue-700 transition-colors"
                    >
                      Clear All Filters
                    </button>
                  </div>
