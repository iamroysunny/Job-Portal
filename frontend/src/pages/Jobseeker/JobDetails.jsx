import { MapPin, IndianRupee, Building2, Clock, User } from "lucide-react";
  ...
  <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50">
    ...
    <div className="container mx-auto pt-24">
      ...
      {jobDetails && (
        ...
        <div className="relative px-0 pb-8 border-8 border-gray-100">
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-6">
              {jobDetails?.company?.companyLogo ? (
                ...
                <div className="h-20 bg-gray-50 border-2 border-gray-200 rounded-2xl flex items-center justify-center">
        ...
        {/* Content sections */}
        <div className="px-0 pb-8 space-y-0">
          {/* Salary section */}
          <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl">
            <div className="absolute top-0 right-0 w-32 bg-gradient-to-br from-emerald-400/10 to-teal-400/10 rounded-full -translate-y-16 translate-x-10"></div>
            <div className="relative z-10">
