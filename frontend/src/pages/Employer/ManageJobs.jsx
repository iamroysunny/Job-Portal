...
const ManageJobs = () => {
  ...
  const pagintedJobs = filterAndSortedJobs.slice(
    startIndex,
  ...
  //Decide which sort icon to display  based on current sort filed and direction
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-row items-center justify-between">
              ...
              <button
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-sm font-semibold rounded-xl shadow-lg shadow-blue-500/25 hover:shadow-blue-500/30 transition-all duration-300 transform hover:-translate-y-0.5 whitespace-nowrap"
              onClick={() => navigate("/post-job")}
              >
                <Plus className="w-3 h-5 mr-2"/>
                About New Job
              </button>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-black/5 border border-white/20 p-6 mb-8">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                className="block w-full pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-0 duration-200 bg-gray-50/50 placeholder-gray-400"
                />
              </div>
            ...
            <div className="my-4">
              <p className="text-sm text-gray-600">
                Showing {pagintedJobs.length} of {filterAndSortedJobs.length}{""}
                jobs
              </p>
            </div>
...
<td className="px-6 py-4">
  <button
    ...
    onClick={() => {
      console.log("Sending Job ID:", job._id);

      navigate("/application-viewer", {
        state: {
          jobId: job._id,
        },
      });
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {job.status === "Active" ? (
                      <button
                        ...
                        className="flex items-center gap-2 text-xs text-orange-800 p-2 rounded-lg hover:bg-orange-50 transition-colors duration-200"
                      >
                        <X className="w-4 h-4" />
                      ...
                      <button
                        onClick={() => handleStatusChange(job.id)}
                        className="flex items-center gap-2 text-xs text-green-600 hover:text-green-800 p-2 rounded-lg transition-colors duration-200"
                      >
...
<div className="flex flex-col md:flex-row items-center justify-between gap-4 mt-6">
  ...
  <div className="flex items-center md:hidden">
    <button
      ...
      className="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
    >
      Previous
    </button>
  ...
  <div className="hidden md:flex items-center gap-2">
    <button
      ...
      disabled={currentPage === 1}
      className="relative inline-flex items-center px-4 py-2 rounded-l-md border border-gray-300 bg-white font-medium text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
    >
      Previous
    </button>
