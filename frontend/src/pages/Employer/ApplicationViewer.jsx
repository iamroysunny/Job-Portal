...
const ApplicationViewer = () => {
  ...
  console.log("Received Job ID:", location.state?.jobId);
  ...
  const groupedApplications = useMemo(() => {
    const filtered = applications.filter(
      (app) => app?.applicant?.name
    );

    return filtered.reduce((acc, app) => {
      const currentJobId = app.job?._id || "default";
          ...
          <div className="space-y-8">
            {Object.values(groupedApplications).map(
              ({ job, applications }) => (
                ...
                >
                  {/* Job Header*/}
                  <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-6 px-4">
                  ...
                  <div className="p-6">
                    <div className="space-y-4">
                      {applications.map((application) =>(
                        <div
                        key={application._id}
                        className="flex flex-col md:flex-row md:items-center justify-between border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
                        >
                          ...
                          <div className="flex items-center gap-3 mt-4 md:m-0">
                            ...
                            className="inline-flex items-center gap-2 px-3 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-colors"
                            >
